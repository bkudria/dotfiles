...
4. **Eval scenarios** — 2-3 scenarios derived from Phase 1 success criteria. Each scenario: prompt, checks (from success criteria), context. Include the eval base.yml.

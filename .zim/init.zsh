...
fpath=("${HOME}/.zim/modules/git/functions" "${HOME}/.zim/modules/utility/functions" "${HOME}/.zim/modules/duration-info/functions" "${HOME}/.zim/modules/git-info/functions" "${HOME}/.zim/modules/archive/functions" "${HOME}/.zim/modules/pvenv/functions" "${HOME}/.zim/modules/prompt-pwd/functions" "${HOME}/.zim/modules/zim-github-cli/functions" "${HOME}/.zim/modules/zim-yq/functions" "${HOME}/.zim/modules/zsh-completions/src" "${HOME}/.zim/modules/bkudria/functions" ${fpath})
autoload -Uz -- git-alias-lookup git-branch-current git-branch-delete-interactive git-branch-remote-tracking git-dir git-ignore-add git-root git-stash-clear-interactive git-stash-recover git-submodule-move git-submodule-remove mkcd mkpw duration-info-precmd duration-info-preexec coalesce git-action git-info archive lsarchive unarchive pvenv prompt-pwd as_system_prompt fix_prompt fix_yaml llm_prompts
...
source "${HOME}/.zim/modules/bkudria/init.zsh"

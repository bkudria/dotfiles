...
class PushDialog(SynchronizeDialog):
    def __init__(self, ui, repository, parent=None):
        ...
        self.setWindowTitle("Mercurial Push")
        self.syncButton.setText("Push")
    ...
    def doSynchronize(self):
        ...
        self._runner = PushRunner(self.onPushDone, self, ui, self._repository, str(self.getUrl()))

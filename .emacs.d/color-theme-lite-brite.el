;;; color-theme-lite-brite.el --- A color theme by Benjamin Kudria
...
;; for the backquote in `color-theme-lite-brite', as well as for running
...
(defun color-theme-lite-brite ()
  "Color theme by Benjamin Kudria <ben@kudria.net>."
  (interactive)
  (setq-default hl-paren-colors '("#ff8800" "#eeff00" "#66ff00" "#00ff22" "#00FFAA" "#00CCFF" "#0044ff" "#4400ff" "#CC00FF" "#FF00AA" "#FF0022" "#ff0000"))
  (color-theme-install
   `(color-theme-lite-brite
	 ...
	 ;; Faces
	 (default ((t (:background "black" :foreground "#e2e2e2"
...
;;; 	 (font-latex-warning-face ((t (:background "indian red" :foreground "white"))))
	 ...
	 (font-lock-special-keyword-face ((t (:foreground "#0F0FFF"))))
	 (font-lock-exit-face ((t (:foreground "#CA220B"))))
...
(provide 'color-theme-lite-brite)

;;; color-theme-lite-brite.el ends here
